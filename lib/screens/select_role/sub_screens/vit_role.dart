...
class VitRole extends StatefulWidget {
  const VitRole({Key? key}) : super(key: key);

  @override
  State<VitRole> createState() => _VitRoleState();
}

class _VitRoleState extends State<VitRole> {
                ...
                child: SingleChildScrollView(
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        const CustomText(
                          title: AppText.clinicName,
                        ),
                        const SizedBox(height: 10),
                        const CustomInput(
                          hintText: AppText.clinicName,
                        ),
                        ...
                        const SizedBox(height: 10),
                        const CustomInput(
                          hintText: AppText.enterYourSpeciality,
                          maxLines: 3,
                        ),
                        const SizedBox(height: 16),

                        const CustomText(
                          title: AppText.registrationNumber,
                        ),
                        const SizedBox(height: 10),
                        const CustomInput(
                          hintText: AppText.regNumber,
                        ),
                        const SizedBox(height: 16),
                        ...
                        UploadWidget(
                          onTap: () {},
                          title: AppText.uploadPassingCertificate,
                        ),
                        const SizedBox(height: 16),
                        CustomCheckBoxListTile(
                          value: checkValue,
