                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        const CustomInput(
                          hintText: AppText.groupName,
                        ),
                        const SizedBox(height: 16),
                        const CustomText(
                          title: AppText.contactFirstName,
                        ),
                        const SizedBox(height: 10),
                        const CustomInput(
                          hintText: AppText.contactFirstName,
                        ),
                        const SizedBox(height: 16),
                        const CustomText(
                          title: AppText.contactLastName,
                        ),
                        const SizedBox(height: 10),
                        const CustomInput(
                          hintText: AppText.contactLastName,
                        ),
                        const SizedBox(height: 16),
                        const CustomText(
                        ...
                        const SizedBox(height: 16),
                        const CustomText(
                          title: AppText.aboutTheGroup,
                        ),

                        const SizedBox(height: 10),
                        const CustomInput(
                          hintText: AppText.briefDescriptionOfGroup,
                          maxLines: 3,
                        ),
                        ...
                        UploadWidget(
                          onTap: () {},
                          title: AppText.uploadRegistrationProof,
                        ),
                        const SizedBox(height: 16),
                        UploadWidget(
                          onTap: () {},
                          title: AppText.uploadEstablishmentPicture,
                        ),
